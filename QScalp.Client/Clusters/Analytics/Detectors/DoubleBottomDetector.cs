// ==========================================================================
//  DoubleBottomDetector.cs — Двойное дно (W-pattern)
// ==========================================================================
...
{
    internal sealed class DoubleBottomDetector : ISignalDetector
    {
        public string Name => "DoubleBottom";
        ...
        static string FormatMessage(ClusterStats t1, ClusterStats t2, int neckline, int t2AgeBars)
        {
            return string.Format(CultureInfo.InvariantCulture,
                ...
                FormatVolume(t1.Volume), FormatVolume(t2.Volume), neckline);
        }
